...
[
	[#Rule _SUPERSTART
		 '$start', 2, undef
#line 251 ./dynamicgrammar.pm
	],
	[#Rule _STAR_LIST
		 'STAR-1', 2,
sub {
#line 46 "dynamicgrammar.eyp"
 goto &Parse::Eyapp::Driver::YYActionforT_TX1X2 }
#line 258 ./dynamicgrammar.pm
	],
	[#Rule _STAR_LIST
		 'STAR-1', 0,
sub {
...
#line 50 "dynamicgrammar.eyp"
 $reduce = 0}
#line 286 ./dynamicgrammar.pm
	],
	[#Rule c_6
		 'c', 1,
sub {
#line 51 "dynamicgrammar.eyp"
 $reduce = 1}
#line 293 ./dynamicgrammar.pm
	],
	[#Rule expr_7
		 'expr', 3,
sub {
...
my $expr = $_[2];  $expr }
#line 300 ./dynamicgrammar.pm
	],
	[#Rule expr_8:M
		 'expr', 5,
sub {
#line 60 "dynamicgrammar.eyp"
my $left = $_[1]; my $right = $_[4];  $left - $right }
#line 307 ./dynamicgrammar.pm
	],
	[#Rule expr_9
		 'expr', 1, undef
#line 311 ./dynamicgrammar.pm
	],
	[#Rule leftORright
		 'leftORright', 0,
sub {
#line 65 "dynamicgrammar.eyp"
  my $self = $_[0];
  for (${$self->input()}) {  
#line 39 "dynamicgrammar.eyp" 

  if ($reduce) { $self->YYSetReduce('-', ':M') } else { $self->YYSetShift('-') }
#line 322 ./dynamicgrammar.pm
  }

}
#line 326 ./dynamicgrammar.pm
	]
],
#line 329 ./dynamicgrammar.pm
    yybypass       => 0,
    yybuildingtree => 0,
    yyprefix       => '',
    yyaccessors    => {
