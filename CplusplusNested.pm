...
#line 430 ./CplusplusNested.pm
	...
	[#Rule decORexp
		 'decORexp', 0,
sub {
#line 67 "CplusplusNested.eyp"
  my $self = $_[0];
  for (${$self->input()}) {  
#line 18 "CplusplusNested.eyp" 
    $self->YYIf('decl', 'ID:DEC', 'ID:EXP');
#line 440 ./CplusplusNested.pm
  }
}
#line 443 ./CplusplusNested.pm
	],
...
#line 453 ./CplusplusNested.pm
  }

}
#line 457 ./CplusplusNested.pm
	]
],
