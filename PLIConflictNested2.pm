...
#        Don't edit this file, use source file 'PLIConflictNested2.eyp' instead.
#
#             ANY CHANGE MADE HERE WILL BE LOST !
#
########################################################################################
package PLIConflictNested2;
use strict;

push @PLIConflictNested2::ISA, 'Parse::Eyapp::Driver';
...
#line 107 ./PLIConflictNested2.pm

my $warnmessage =<< "EOFWARN";
Warning!: Did you changed the \@PLIConflictNested2::ISA variable inside the header section of the eyapp program?
EOFWARN
...
{ '' => { ISSEMANTIC => 0 },
    ...
    yyFILENAME  => 'PLIConflictNested2.eyp',
    yystates =>
[
	{#State 0
		ACTIONS => {
...
[
	[#Rule _SUPERSTART
		 '$start', 2, undef
#line 250 ./PLIConflictNested2.pm
	],
	[#Rule stmt_1
		 'stmt', 1,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 257 ./PLIConflictNested2.pm
	],
	[#Rule stmt_2
		 'stmt', 1,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 264 ./PLIConflictNested2.pm
	],
	[#Rule IF
		 'ifstmt', 4,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 271 ./PLIConflictNested2.pm
	],
	[#Rule ASSIGN
		 'assignstmt', 3,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 278 ./PLIConflictNested2.pm
	],
	[#Rule EQ
		 'expr', 3,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 285 ./PLIConflictNested2.pm
	],
	[#Rule expr_6
		 'expr', 1,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 292 ./PLIConflictNested2.pm
	],
	[#Rule ID
		 'id', 1,
sub {
#line 44 "PLIConflictNested2.eyp"
 goto &Parse::Eyapp::Driver::YYBuildAST }
#line 299 ./PLIConflictNested2.pm
	]
],
#line 302 ./PLIConflictNested2.pm
    yybypass       => 1,
    yybuildingtree => 1,
    yyprefix       => '',
    yyaccessors    => {
...
#line 72 "PLIConflictNested2.eyp"
...
#line 338 ./PLIConflictNested2.pm
